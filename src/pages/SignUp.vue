    ...
    <div class="flex h-full justify-center items-center">
      <div class="flex flex-col p-8 sm:w-[560px] font-light">
        ...
        <q-form @submit="onSubmit">
          <q-input outlined v-model="firstName" label="First Name" type="text" name="firstName" class="mb-4"/>
          <q-input outlined v-model="lastName" label="Last Name" type="text" name="lastName" class="mb-4"/>
          <q-input outlined v-model="nickname" label="Nickname" type="text" name="nickname" class="mb-4"/>
